<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="RestaurantPOC1.WebForm1" %>
...
<body>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">Lipsmacking</a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav main-nav  clear navbar-right ">
                        ...
                        <li><a class="color_animation" href="#feedback">FEEDBACK</a></li>
    ...
    <section id="story" class="description_content">
        ...
        <table class='table' style="width: 100%;">
            ...
            <tr></tr>
            <tr>
                <td style="column-span: all">Menu</td>

            </tr>
            <tr>
                <td>
                    <asp:DropDownList AutoPostBack="true" ID="menuddl" runat="server" OnSelectedIndexChanged="menuddl_SelectedIndexChanged"></asp:DropDownList>
                </td>
            </tr>
            <tr>
                <td><asp:Label runat="server">Remane:&nbsp</asp:Label><asp:TextBox ID="txtNewName" runat="server"></asp:TextBox></td>
    ...
    <section id="reservation" class="description_content">
        ...
        <div class="text-content container">
            <div class="inner contact">
                <h1 style="width:auto;font-size:20px">Select a grey table</h1>
                <!-- Form Area -->
                                ...
                                <div class="col-lg-8 col-md-6 col-xs-12">
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-xs-6">
                                            ...
                                            <button type="button" class="btn btn-success">Table 1</button>
                                            <button type="button" class="btn btn-secondary">Table 2</button>
                                            <button type="button" class="btn btn-success">Table 3</button>
                                            <button type="button" class="btn btn-secondary">Table 4</button>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-xs-6">
                                            <!-- Name -->
                                            <button  type="button" class="btn btn-secondary">Table 5</button>
                                            <button type="button" class="btn btn-success">Table 6</button>
                                            <button type="button" class="btn btn-secondary">Table 7</button>
                                            <button type="button" class="btn btn-success">Table 8</button>
                                        </div>
                                        <div class="col-xs-12 ">
                                            <!-- Send Button -->
                                            <button style="float:none" type="submit" id="submit" name="submit" class="text-center form-btn">Reserve</button>
                                        </div>
...
18
19 <!-- ============ Feedback Section  ============= -->
20<section id="feedback">
<div id="feedback">
   <div id="feedback-form" style='display:none;' class="col-xs-4 col-md-4 panel panel-default">
    <form method="POST" action="/feedback" class="form panel-body" role="form">
        <div class="form-group">
         <input class="form-control" name="yname" autofocus placeholder="Your Name" type="email" />
             </div>
               <div class="form-group">
                   <input class="form-control" name="email" placeholder="Your e-mail" type="email" />
              </div>
              <div class="form-group">
                  <input class="form-control" name="subject" placeholder="Subject" type="email" />
              </div>                               
              <div class="form-group">
       ...
       <div id="feedback-tab">Contact Us</div>
</div>
</section>
